import { db } from "@/db";
import {
  brands, categories, collections, colors, genders, insertBrandSchema, insertCategorySchema, insertCollectionSchema, insertColorSchema, insertGenderSchema, insertProductImageSchema, insertProductSchema, insertSizeSchema, insertVariantSchema, productCollections, productImages, products, productVariants, sizes,
